            ...
            >
              ...
              <div className="relative z-10 flex flex-col lg:flex-row gap-12">
                ...
                <div className="lg:w-1/3 flex flex-col gap-6">
                  <div className="p-8 rounded-3xl bg-white border border-border shadow-xs">
                    ...
                    <ul className="space-y-4">
                      {project.highlights.map((highlight, i) => (
                        <li key={i} className="flex items-start gap-3 text-[14px] text-foreground/90 leading-relaxed font-medium">
