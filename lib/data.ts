export const resume = {
  ...
  experience: [
    {
      ...
      description:
        "커뮤니티 매칭 서비스 '동행'의 모바일 앱(Flutter) · 웹 어드민(Next.js) 개발 및 성능/지표 개선 담당",
      highlights: [
        ...
        "**화상 인터뷰 시스템 0→1 설계·개발·배포**: 스펙(UI·API·에러케이스)을 먼저 문서화하고, Server Actions + Result 패턴으로 성공/실패 흐름을 일원화해 7일 런칭 / 주당 15h 절감",
  ...
  caseStudies: [
    ...
    },
    {
      ...
      results: [
        { label: "런칭 기간", value: "7일" },
        { label: "운영 시간 절감", value: "주당 15h↓" },
      ],
